...
public class Common {
 public static final String RESOURCE_SERVER_NAME = "Example OAuth Resource Server";
    public static final String ACCESS_TOKEN_VALID = "importanttoken";
    ...
    public static final String CLIENT_ID = "key";
    ...
    public static final String ACCESS_TOKEN_ENDPOINT = "http://term.ie/oauth/example/access_token.php";
    public static final String UNAUTHENTICATED_ACCESS_TOKEN_ENDPOINT = "http://term.ie/oauth/example/access_token.php";
    public static final String AUTHORIZATION_ENPOINT = "http://term.ie/oauth/example/echo_api.php";
    public static final String REDIRECT_URL = "http://term.ie/oauth/example/request_token.php";
